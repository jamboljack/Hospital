            ...
            <div class="modal-body">                
                ...
                <div class="form-group">                    
                    ...
                    <div class="col-md-2 has-error">
                        <input type="text" class="form-control" placeholder="Kode Pos" name="zipcode" autocomplete="off" maxlength="5">
                    </div>
                </div>
                <div class="form-group">                    
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">                
                ...
                <div class="form-group">                    
                    <label class="col-md-3 control-label">Kode Pos</label>
                    <div class="col-md-2 has-error">
                        <input type="text" class="form-control pelanggan_zipcode" placeholder="Kode Pos" name="zipcode" autocomplete="off" maxlength="5">
                    </div>
                </div>
                <div class="form-group">                    
                    <label class="col-md-3 control-label">No. Telpon</label>
