            ...
            <div class="col-md-12">
                ...
                <div class="portlet box red-intense">
                    ...
                    <div class="portlet-body form">
                        <form role="form" class="form-horizontal" action="<?php echo site_url('admin/dokter/savedatajadwal'); ?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    <label class="col-md-3 control-label" for="form_control_1">Polispesialis</label>
                                    <div class="col-md-6">
                                        <select class="select2_category form-control" data-placeholder="- Pilih Polispesialis -" name="lstPoli" id="lstPoli" required>
                                            <option value="">- Pilih Polispesialis -</option>
                                            <?php 
                                            foreach($listPoli as $p) { 
                                            ?>
                                            <option value="<?php echo $p->poliklinik_id; ?>" <?php echo set_select('lstPoli', $p->poliklinik_id); ?>><?php echo $p->poliklinik_name; ?></option>
                                            <?php 
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <input type="text" class="form-control timepicker timepicker-24" name="mulai">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            <input type="text" class="form-control timepicker timepicker-24" name="selesai">
                                            <span class="input-group-btn">
                                                <button class="btn default" type="button"><i class="fa fa-clock-o"></i></button>
                                            </span>
                                        </div>
