        ...
        <div class="modal-content">
            ...
            <div class="modal-body">                
                ...
                <div class="form-group">                    
                    ...
                    <div class="col-md-9 has-error">
                        <input type="text" class="form-control" placeholder="Enter Kota" name="city" autocomplete="off">
                    </div>
                </div>
                <div class="form-group">                    
                    <label class="col-md-3 control-label">No. Telpon</label>
                    <div class="col-md-9 has-error">
                        <input type="text" class="form-control" placeholder="Enter No. Telpon" name="phone" autocomplete="off">
                    </div>
                </div>                
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">                
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">Alamat</label>
                    <div class="col-md-9 has-error">                                            
                        <textarea class="form-control dokter_address" name="address" rows="3"></textarea>
                    </div>
                </div>
                <div class="form-group">                    
                    <label class="col-md-3 control-label">Kota</label>
                    <div class="col-md-9 has-error">
                        <input type="text" class="form-control dokter_city" placeholder="Enter Kota" name="city" autocomplete="off">
                    </div>
                </div>
                <div class="form-group">                    
                    <label class="col-md-3 control-label">No. Telpon</label>
                    <div class="col-md-9 has-error">
                        <input type="text" class="form-control dokter_phone" placeholder="Enter No. Telpon" name="phone" autocomplete="off">
                    </div>
                </div>
            </div>
...
<div class="page-content-wrapper">
    <div class="page-content">            
        <h3 class="page-title">
            Master Medis <small>Dokter</small>
        </h3>
        <div class="page-bar">
