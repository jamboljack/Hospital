                        ...
                        <input type="hidden" name="id" value="<?php echo $detail->user_username; ?>" />
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" placeholder="Enter No. Handphone" name="phone" value="<?php echo $detail->user_phone; ?>" pattern="^[0-9]{1,12}$" title="Hanya Angka, maksimal 12 Digit" maxlength="12" autocomplete="off" required>
                                        <div class="form-control-focus"></div>
