...
<body class="login-body">
	<div class="container">
		<br><br><br>	
        <div align="center">
            <img src="<?php echo base_url(); ?>img/panel.png">            
        </div>
        ...
        <form class="form-signin" action="<?php echo site_url('login/validasi'); ?>" name="login" method="post">
            ...
            <h2 class="form-signin-heading">Masukkan User & Password :</h2>
                <div class="login-wrap">            
                    <input id="username" type="text" class="form-control" name="username" value="<?php echo set_value('username'); ?>" pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{1,20}$" title="Jangan pakai Spasi" placeholder="Username Anda" autofocus required>
                    ...
                    <button class="btn btn-lg btn-login btn-block" type="submit"><i class="fa fa-sign-in"></i> Login</button>
        	   </div>            
        </form>
